...
def good_probe():
    ...
    return SnapshotLineProbe.create(
...
def test_debugger_multiple_threads():
    with debugger() as d:
        d.add_probes(
            good_probe(),
            SnapshotLineProbe.create(probe_id="thread-test", source_file="tests/submod/stuff.py", line=40),
        )
        sleep(0.5)
