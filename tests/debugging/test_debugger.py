...
def test_debugger_condition_eval_then_rate_limit():
    ...
    with debugger(upload_flush_interval=0.1) as d:
        ...
        # Stuff().instancestuff(42) called only once.
        # Therefore. it only check that condition executed before rate limit.
        # If rate limit was not working this doesn't catch it as it only run once.
