...
def test_registry_contains():
    probe_in = SnapshotLineProbe.create(probe_id=42, source_file="foo", line=1)
    probe_out = SnapshotLineProbe.create(probe_id=0, source_file="foo", line=2)
...
def test_registry_pending():
    ...
    probes = [SnapshotLineProbe.create(probe_id=i, source_file=__file__, line=i) for i in range(10)]
...
def test_registry_location_error():
    ...
    probe = SnapshotLineProbe.create(probe_id=42, source_file=__file__, line=1)
